...
class EmbedLayer(nn.Module):
    def __init__(self, n_channels, embed_dim, image_size, patch_size):
        ...
        self.pos_embedding = nn.Parameter(torch.zeros(1, (image_size // patch_size) ** 2, embed_dim),
...
class ImageSet2Set(nn.Module):
    ...
    def __init__(self, n_out_max=64, d_out=2, d_hidden=32, d_mlp=128, n_heads=4, n_encoder_layers=2, n_decoder_layers=2,
        ...
        self.transformer = Transformer(d_hidden, n_heads, n_encoder_layers, n_decoder_layers, dim_feedforward=d_mlp,
